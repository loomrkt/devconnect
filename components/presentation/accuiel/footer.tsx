        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="py-8 flex flex-col-reverse sm:flex-row items-center justify-between gap-x-2 gap-y-5 px-6 xl:px-0">
            ...
            <span className="text-muted-foreground">
              ...
              <Link className="text-indigo-900" href="https://www.linkedin.com/in/nameno-fanantenana-rakotondrazaka-248a59283/" target="_blank">
                Nameno Fanantenana Rakotondrazaka
              </Link>
            </span>

            <div className="flex items-center gap-5 text-muted-foreground">
              <Link href="https://www.linkedin.com/in/nameno-fanantenana-rakotondrazaka-248a59283/" target="_blank">
